        ...
        for (ticket in customerTickets) {
            ...
            if (product.isActive == "0" && product.flag == "0") {
                ...
                if (shop?.flag == "0" && shop.isActive == "0") {
                    ...
                    if (image != null) {
                        emit(ProductTicket(ticket, imageUrl = image.productImages, userDetails = userDetails, productName =product.productName , mrp = product.mrp, sellingPrice = product.sellingPrice, onCall = product.onCall))
                    }
                }
            }
        }
